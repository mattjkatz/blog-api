...
RSpec.describe "Posts", type: :request do
  ...
  describe "GET /posts/:id" do
    it "should return the attributes of one specific post" do
      ...
      post = Post.create!(user_id: user.id, title: title, body: body, image: "https://i.picsum.photos/id/302/200/300.jpg?hmac=b5e6gUSooYpWB3rLAPrDpnm8PsPb84p_NXRwD-DK-1I")
